...
namespace Calculator_WinUI.Tests
{
    ...
    internal static class Vocabulary
    {
        ...
        {
            return Path.Combine(RepositoryRoot(), "Calculator_WinUI", "Views", "StandardPage.xaml");
        }

        private static string RepositoryRoot([CallerFilePath] string testSourcePath = "")
        {
            // this file sits in Calculator_WinUI.Tests, one level under the repository root
